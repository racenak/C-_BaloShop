...
CREATE TABLE `SalesOrderDetail` (
  ...
  CONSTRAINT `SalesOrderDetail_SpecialOfferProduct_FK` FOREIGN KEY (`SpecialOfferID`) REFERENCES `SpecialOfferProduct` (`SpecialOfferID`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SalesOrderDetail` VALUES (8,1,4,28,1,20.6,9.55,44.2,'2024-10-24 16:59:33'),(10,2,5,12,1,11.8,3.67,40.65,'2024-10-24 16:59:33'),(2,3,2,16,1,30.33,11.55,37.56,'2024-10-24 16:59:33'),(9,4,6,18,1,86.29,4.66,489.78,'2024-10-24 16:59:33'),(9,5,10,16,1,56.63,25.89,307.4,'2024-10-24 16:59:33'),(9,6,1,16,1,16.08,7.35,8.73,'2024-10-24 16:59:33'),(5,7,3,4,1,80.85,37,131.55,'2024-10-24 16:59:33'),(1,8,5,14,1,33.58,6.7,134.4,'2024-10-24 16:59:33'),(5,9,6,8,1,13.75,2.77,65.88,'2024-10-24 16:59:33'),(3,10,7,20,1,81.88,25.46,394.94,'2024-10-24 16:59:33');
...
INSERT INTO `SalesOrderHeader` VALUES (1,'2024-03-20 14:17:49',5,1,341.1,34.11,375.21,'2024-10-24 16:37:42'),(2,'2024-04-17 02:03:05',3,2,130.3,13.03,143.33,'2024-10-24 16:37:42'),(3,'2024-04-16 01:20:08',4,2,407.71,40.77,448.48,'2024-10-24 16:37:42'),(4,'2024-03-04 03:17:09',4,4,551.57,55.16,606.73,'2024-10-24 16:37:42'),(5,'2024-06-17 18:33:33',3,1,707.79,70.78,778.57,'2024-10-24 16:37:42'),(6,'2024-04-25 07:03:43',5,1,304.54,30.45,334.99,'2024-10-24 16:37:42'),(7,'2024-02-24 02:53:11',3,2,948.52,94.85,1043.37,'2024-10-24 16:37:42'),(8,'2024-07-04 01:11:23',3,1,436.44,43.64,480.08,'2024-10-24 16:37:42'),(9,'2024-07-14 22:19:46',4,4,641.16,64.12,705.28,'2024-10-24 16:37:42'),(10,'2024-10-20 20:47:03',3,1,557.39,55.74,613.13,'2024-10-24 16:37:42');
...
CREATE TABLE `SpecialOfferProduct` (
  ...
  `ModifiedDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`SpecialOfferID`),
  KEY `SpecialOfferProduct_Product_FK` (`ProductID`),
  CONSTRAINT `SpecialOfferProduct_Product_FK` FOREIGN KEY (`ProductID`) REFERENCES `Product` (`ProductID`),
  CONSTRAINT `SpecialOfferProduct_SpecialOffer_FK` FOREIGN KEY (`SpecialOfferID`) REFERENCES `SpecialOffer` (`SpecialOfferID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SpecialOfferProduct` VALUES (1,1,'2024-10-24 16:58:40');
...
-- Dump completed on 2024-10-25  0:03:52
